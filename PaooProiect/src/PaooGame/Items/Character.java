...
{
    public static final int DEFAULT_LIFE            = 6;   /*!< Valoarea implicita a vietii unui caracter.*/
    ...
    /*! \fn public Character(PaooGame.RefLinks refLink, float x, float y, int width, int height)
